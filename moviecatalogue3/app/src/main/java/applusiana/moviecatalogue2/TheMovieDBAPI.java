...
public class TheMovieDBAPI {
    ...
    public static void get(String tv, RequestParams requestParams, AsyncHttpResponseHandler asyncHttpResponseHandler) {
        TheMovieDBAPI.url = url;
        TheMovieDBAPI.requestParams = requestParams;
        TheMovieDBAPI.asyncHttpResponseHandler = asyncHttpResponseHandler;
