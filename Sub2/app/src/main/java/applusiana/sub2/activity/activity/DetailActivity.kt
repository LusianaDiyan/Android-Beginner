...
import android.support.v7.appcompat.R.id.home
...
import applusiana.sub2.activity.presenter.DetailMatch
import applusiana.sub2.activity.presenter.MatchDetail
...
class DetailActivity: AppCompatActivity(),DetailView, MainView {
    ...
    private lateinit var detail: DetailMatch
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        detail = DetailMatch(this, request, gson)
